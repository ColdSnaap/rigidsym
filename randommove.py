...
class AtomRandomMove:
    ...
    def symmetry_restricted(self, rigid_or_single, algorithm, temp, wyckoff_position, *args):
        if rigid_or_single == 'rigid':
            ...
            if wyckoff_position[1] != 'y' and wyckoff_position[1] != '-x':
                atoms_move[1] = 0
            elif wyckoff_position[1] != 'y' and wyckoff_position[1] == '-x':
                atoms_move[1] = (-1.0) * atoms_move_single[0]
            else:
            ...
            if wyckoff_position[1] != 'y' and wyckoff_position[1] != 'x+0.5':
                ...
                atoms_move_single[1] = atoms_move_single[0]
            elif wyckoff_position[1] != 'y' and wyckoff_position[1] == '-x':
                atoms_move[1] = (-1.0) * atoms_move_single[0]
            else:
